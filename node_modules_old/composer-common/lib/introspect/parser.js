module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c412 = function(abstract, id, idField, classExtension, body) {
              return {
        ...
        peg$c413 = function(abstract, id, idField, classExtension, body) {
                  return {
        ...
        peg$c414 = function(ex) {
              return {
                type:   "ClassExtension",
                class:     ex
              };
            },
        peg$c415 = function(abstract, id, idField, classExtension, body) {
              return {
        ...
        peg$c416 = function(abstract, id, idField, classExtension, body) {
              return {
        ...
        peg$c417 = function(abstract, id, classExtension, body) {
                  return {
        ...
        peg$c418 = "optional",
        peg$c419 = { type: "literal", value: "optional", description: "\"optional\"" },
        peg$c420 = function() {
              return {
                type: "Optional"
              };
            },
        peg$c421 = function(def) {
              return def.value;
            },
        peg$c422 = function(def) {
              return def;
            },
        peg$c423 = function(def) {
             return def;
            },
        peg$c424 = function(decls) {
              return {
        ...
        peg$c425 = "o",
        peg$c426 = { type: "literal", value: "o", description: "\"o\"" },
        peg$c427 = "[]",
        peg$c428 = { type: "literal", value: "[]", description: "\"[]\"" },
        peg$c429 = function(propertyType, array, id, d, optional) {
            	return {
        ...
        peg$c430 = function(array, id, d, optional) {
            	return {
            		type: "FieldDeclaration",
            		id: id,
        ...
        peg$c431 = function(array, id, d, optional) {
            	return {
            		type: "FieldDeclaration",
            		id: id,
        ...
        peg$c432 = function(array, id, d, regex, optional) {
            	return {
            		type: "FieldDeclaration",
            		id: id,
        ...
        peg$c433 = "regex",
        peg$c434 = { type: "literal", value: "regex", description: "\"regex\"" },
        peg$c435 = function(regex) {
           	return regex
          },
        peg$c436 = "range",
        peg$c437 = { type: "literal", value: "range", description: "\"range\"" },
        peg$c438 = function(lower, upper) {
           	return {
              lower: lower,
              upper: upper
            }
          },
        peg$c439 = function(propertyType, array, id, d, range, optional) {
            	return {
            		type: "FieldDeclaration",
            		id: id,
        ...
        peg$c441 = function(decls) {
              return {
                type: "EnumDeclarationBody",
                declarations: optionalList(decls)
              };
            },
        peg$c442 = function(id, optional) {
            	return {
        ...
        peg$c445 = function(propertyType, array, id, optional) {
            	return {
        ...
        peg$c446 = function(first, rest) {
            return first.concat(JSON.stringify(rest).replace(/['"]+/g, ''));
          },
        peg$c447 = function(namespace) {
          	return namespace;
          },
        peg$c448 = ".*",
        peg$c449 = { type: "literal", value: ".*", description: "\".*\"" },
        peg$c450 = function(ns) {
            	return ns;
          },
        peg$c451 = function(ns, imports, body) {
              return {
                type: "Program",
                namespace: ns,
                  ...
                  if (s7 !== peg$FAILED) {
                    ...
                    if (s8 !== peg$FAILED) {
                      ...
                      if (s9 !== peg$FAILED) {
                        s10 = peg$parse__();
                        if (s10 !== peg$FAILED) {
                          s11 = peg$parseClassDeclarationBody();
                          if (s11 !== peg$FAILED) {
                            s12 = peg$parse__();
                            if (s12 !== peg$FAILED) {
                              if (input.charCodeAt(peg$currPos) === 125) {
                  ...
                  if (s7 !== peg$FAILED) {
                    ...
                    if (s8 !== peg$FAILED) {
                      ...
                      if (s9 !== peg$FAILED) {
                        s10 = peg$parse__();
                        if (s10 !== peg$FAILED) {
                          s11 = peg$parseStringRegexValidator();
                          if (s11 === peg$FAILED) {
                            s11 = null;
                          }
                          if (s11 !== peg$FAILED) {
                  ...
                  if (s7 !== peg$FAILED) {
                    ...
                    if (s8 !== peg$FAILED) {
                      ...
                      if (s9 !== peg$FAILED) {
                        s10 = peg$parse__();
                        if (s10 !== peg$FAILED) {
                          s11 = peg$parseRealDomainValidator();
                          if (s11 === peg$FAILED) {
                            s11 = null;
                          }
                          if (s11 !== peg$FAILED) {
                            ...
                            if (s12 !== peg$FAILED) {
                              ...
                              if (s13 !== peg$FAILED) {
                                ...
                                if (s14 !== peg$FAILED) {
                                  peg$savedPos = s0;
                                  s1 = peg$c439(s3, s5, s7, s9, s11, s13);
                                  s0 = s1;
                                } else {
                                  peg$currPos = s0;
                                  s0 = peg$FAILED;
                  ...
                  if (s7 !== peg$FAILED) {
                    ...
                    if (s8 !== peg$FAILED) {
                      ...
                      if (s9 !== peg$FAILED) {
                        s10 = peg$parse__();
                        if (s10 !== peg$FAILED) {
                          s11 = peg$parseIntegerDomainValidator();
                          if (s11 === peg$FAILED) {
                            s11 = null;
                          }
                          if (s11 !== peg$FAILED) {
          ...
          if (s3 !== peg$FAILED) {
            ...
            if (s4 !== peg$FAILED) {
              ...
              if (s5 !== peg$FAILED) {
                s6 = peg$parse__();
                if (s6 !== peg$FAILED) {
                  s7 = peg$parseEnumDeclarationBody();
                  if (s7 !== peg$FAILED) {
                    s8 = peg$parse__();
                    if (s8 !== peg$FAILED) {
                      if (input.charCodeAt(peg$currPos) === 125) {
